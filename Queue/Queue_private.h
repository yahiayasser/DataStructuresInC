...
static Queue_ErrorType Queue_InsertAtLast(Queue* QUEUE, Queue_DataSize data, Queue_node** head);
static void Queue_FREE(Queue_node* PtrToNode);
static Queue_ErrorType Queue_DeleteHead(Queue* QUEUE, Queue_node** head);
static Queue_ErrorType Queue_DeleteElement(Queue* QUEUE, Queue_node** head, uint8 index);
